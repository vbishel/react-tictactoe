...
export default function PageContainer({ children, className}: Props) {
  return (
    <>
      ...
      <div
      className={`grid grid-rows-3 grid-cols-3 w-[380px] h-[380px] border-primary-light border-2 box-content "opacity-5 absolute left-1/2 translate-x-[-50%] translate-y-[2px]`}
      >
        {
